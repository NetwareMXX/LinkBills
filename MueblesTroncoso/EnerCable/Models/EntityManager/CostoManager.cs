...
namespace Troncoso.Models.EntityManager
{
    public class CostoManager
    {
        ...
        private string PintaHtml(DataSet _ds)
        {
            ...
            {
                _html.Append("<tr>");
                _html.Append("<td scope='row'><input tipopol='"+ _row["Mov_TipoPol"] + "' movmes='"+ _row["MOV_MES"] + "' consmov='"+ _row["MOV_CONSMOV"] + "' conspol='"+ _row["MOV_CONSPOL"] + "'  id='chk" + _contado + "' valor='"
                    + _row["IdMovimientoCosto"] + "' type='checkbox' " + " class='chkPer filled-in'><label for='chk" + _contado + "'>" + _row["IdMovimientoCosto"] + "</label></td>");
                _html.Append("<td>" + (_row["CorreccionSerie"].ToString() == "1" ? "SI" : "<a id='aSerie" + _row["IdMovimientoCosto"] + "' onclick='return Corregir(0,1,"+"\""+ _row["Mov_TipoPol"]  +"\","
                    +"\"" + _row["MOV_CONSPOL"] + "\"," + "\"" + _row["MOV_CONSMOV"] + "\","  +"\"" + _row["MOV_MES"] + "\"," + _row["IdMovimientoCosto"] + ");' href='#'>NO</a>")  + "</td>");
                _html.Append("<td>" + (_row["CorreccionFactura"].ToString() == "1" ? "SI" : "<a id='aFactura" + _row["IdMovimientoCosto"] + "' onclick='return Corregir(1,0," + "\"" + _row["Mov_TipoPol"] + "\","
                    + "\"" + _row["MOV_CONSPOL"] + "\"," + "\"" + _row["MOV_CONSMOV"] + "\"," + "\"" + _row["MOV_MES"] + "\"," + _row["IdMovimientoCosto"] + ");' href='#'>NO</a>") + "</td>");
                _html.Append("<td id='tdFactura"+ _row["IdMovimientoCosto"] + "'>" + _row["Factura"] + "</td>");
                _html.Append("<td id='tdSerie" + _row["IdMovimientoCosto"] + "'>" +  _row["Serie"] + "</td>");
        ...
        public string obtenerFacturasPorSerie(string IdMovimientosCostos, string TipoDePolizas, int IdTabla, int idUsuario, ref string success)
        {
            ...
            try
            {
                string Sp = "dbo.BuscarFacturasEnOtrasPolizasPorSerie";
                SqlParameter[] Parametros = new SqlParameter[4];
                Parametros[0] = new SqlParameter("@IdMovimientosCostos", IdMovimientosCostos);
                Parametros[1] = new SqlParameter("@IdUsuario", idUsuario);
        ...
        public string obtenerFacturasPorFactura(string IdMovimientosCostos, string TipoDePolizas, int IdTabla, int idUsuario, ref string success)
        {
            ...
            try
            {
                string Sp = "dbo.BuscarSerieEnOtrasPolizasPorFactura";
                SqlParameter[] Parametros = new SqlParameter[4];
                Parametros[0] = new SqlParameter("@IdMovimientosCostos", IdMovimientosCostos);
                Parametros[1] = new SqlParameter("@IdUsuario", idUsuario);
                Parametros[2] = new SqlParameter("@TipoDePolizas", TipoDePolizas);
        ...
        #region desligarCorrecion
        public string desligarCorrecion(int idTabla, int movConsPol, int movConsMov, int movMes, string movTipoPol, int eliminarFactura, int eliminarSerie,long idSesion, ref string success)
        {
            ...
            try
            {
                string Sp = "dbo.DesligarCorreccion";
                SqlParameter[] Parametros = new SqlParameter[8];
                Parametros[0] = new SqlParameter("@IdTabla", idTabla);
                Parametros[1] = new SqlParameter("@MOV_CONSPOL", movConsPol);
                Parametros[2] = new SqlParameter("@MOV_CONSMOV", movConsMov);
                Parametros[3] = new SqlParameter("@MOV_MES", movMes);
                Parametros[4] = new SqlParameter("@MOV_TIPOPOL", movTipoPol);
                Parametros[5] = new SqlParameter("@EliminarFactura", eliminarFactura);
                Parametros[6] = new SqlParameter("@EliminarSerie", eliminarSerie);
                Parametros[7] = new SqlParameter("@IdSesion", idSesion);
        ...
        #region CorregirFacturaOSerie
        public string CorregirFacturaOSerie(int idTabla, int movConsPol, int movConsMov, int movMes, string movTipoPol, int aplicaFactura,string factura, int aplicaSerie,string serie, long idSesion, ref string success)
        {
            ...
            try
            {
                string Sp = "dbo.CorregirFacturaOSerie";
                ...
                Parametros[3] = new SqlParameter("@MOV_MES", movMes);
                Parametros[4] = new SqlParameter("@MOV_TIPOPOL", movTipoPol);
                Parametros[5] = new SqlParameter("@AplicaFactura", aplicaFactura);
                Parametros[6] = new SqlParameter("@AplicaSerie", aplicaSerie);
                Parametros[7] = new SqlParameter("@Factura", factura);
                Parametros[8] = new SqlParameter("@Serie", serie);
                Parametros[9] = new SqlParameter("@IdSesion", idSesion);
